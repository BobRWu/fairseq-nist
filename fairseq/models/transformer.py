...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        self.layers.extend([
            TransformerEncoderLayer(self.rpr, args)
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        if self.embed_positions is not None and self.rpr is False:
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.layers = nn.ModuleList([])
        self.layers.extend([
            TransformerDecoderLayer(self.rpr, args, no_encoder_attn)
    ...
    def extract_features(self, prev_output_tokens, encoder_out=None, incremental_state=None, **unused):
        ...
        ) if self.embed_positions is not None and self.rpr is False else None
